...
\begin{table}[!t]
  ...
  \begin{tabular}{lccccc}
    \toprule
    \textbf{Filter} & \textbf{Coll./run} & \textbf{Clearance (m)} & \textbf{Interv. (\%)} & \textbf{$|\Delta$steer$|$} & \textbf{$|\Delta$thr$|$}\\
    \midrule
    None         & $3.05$ & $-1.83$ & --- & --- & ---\\
...
\begin{table}[!t]
  ...
  \begin{tabular}{lccccc}
    \toprule
    \textbf{Variant} & \textbf{Coll./run} & \textbf{Clearance (m)} & \textbf{Interv. (\%)} & \textbf{$|\Delta$steer$|$} & \textbf{$|\Delta$thr$|$}\\
    \midrule
...
\begin{table}[!t]
  ...
  \begin{tabular}{lccccc}
    ...
    \textbf{DOB-CBF, with NN} & $\mathbf{0.48}$ & $\mathbf{+0.12}$ & $50$ & $0.69$ & $0.26$\\
    \bottomrule
  \end{tabular}
\end{table}
