...
\begin{table}[!t]
  ...
  \begin{tabular}{lccccc}
    ...
    \textbf{Variant} & \textbf{Coll./run} & \textbf{Clearance (m)} & \textbf{Interv. (\%)} & $\mathbf{|\Delta\delta|}$ & $\mathbf{|\Delta\tau|}$\\
    \midrule
    None (no filter) & $3.06$ & $-1.84$ & --- & --- & ---\\
    DOB-CBF, no NN   & $1.86$ & $-0.62$ & $44$ & $0.29$ & $0.27$\\
    \textbf{DOB-CBF, NN} & $\mathbf{0.65}$ & $\mathbf{+0.32}$ & $56$ & $0.28$ & $0.36$\\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!t]
  ...
  \begin{tabular}{lccccc}
    ...
    \midrule
    None      & $0.89$ ($40/45$) & --- & $-1.69$ & --- & ---\\
    \textbf{DOB-CBF} & $\mathbf{0.20}$ ($9/44$) & $\mathbf{31/39}$ & $\mathbf{+1.94}$ & $0.13$ & $0.28$\\
    \bottomrule
  \end{tabular}
\end{table}
