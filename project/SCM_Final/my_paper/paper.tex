...
filter over-steered ($|\Delta\delta|\!=\!0.23$) and stalled the truck in the
boulder field, colliding where the operator had squeezed past. On genuine human
intent the filter thus restores large clearance margins on the cases it is
...
\begin{figure}[!t]
  ...
  \caption{Counterfactual replay on ten \emph{recorded human} G29 drives (five
    ...
    case where the filter over-steered into the boulder field.}
  \label{fig:teleop_cf}
\end{figure}
