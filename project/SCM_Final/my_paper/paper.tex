...
concentrated in the longitudinal channel: the surrogate under-predicts
soft-soil motion resistance, the same gap the throttle disturbance
observer (Sec.~\ref{sec:throttledob}) compensates online and that the
$10\,$Hz re-planning masks in closed loop. This identifies $F_x$ as the
surrogate's primary improvement target, distinct from the
already-accurate lateral ($F_y$) channel.
