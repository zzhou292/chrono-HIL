...
feedforward term helps where calibrated (sand speed ratio
$0.60\!\to\!0.64$, dirt $0.82\!\to\!0.85$) and is correctly inert on
clay, but it \emph{cannot replace} the observer: the DOB is higher on
every terrain (clay $0.70$ vs.\ $0.54$, sand $0.67$ vs.\ $0.64$) because
...
($3.20\!\to\!3.39$ vs.\ DOB $3.79\,$m/s) but \emph{over}-throttles
firmer dirt ($5.01\!\to\!4.80$, below even no compensation) and raises
...
but inflates clay CTE ($0.20\!\to\!0.35\,$m). The longitudinal
...
\begin{table}[!t]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
    clay & $0.53$ & $0.54$ & $\mathbf{0.70}$\\
    dirt & $0.82$ & $0.85$ & $\mathbf{0.88}$\\
    sand & $0.60$ & $0.64$ & $\mathbf{0.67}$\\
    \bottomrule
  \end{tabular}
\end{table}
