...
* ``MPPIShield`` — Model Predictive Path Integral.  Sample K candidate
  ...
  importance-weighted mean of the first action.  This is the predictive
  learned-dynamics shield: it has no QP linearization, no class-K
  tuning, and handles non-convex multi-obstacle costs without
  singularities.
