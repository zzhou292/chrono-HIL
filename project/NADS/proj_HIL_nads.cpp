...
int main(int argc, char *argv[])
{
    ...
    tf_handler->AddSensor(std::dynamic_pointer_cast<ChSensor>(driver_cam), "world", "camera");
    tf_handler->AddSensor(std::dynamic_pointer_cast<ChSensor>(lidar), "world", "lidar");
